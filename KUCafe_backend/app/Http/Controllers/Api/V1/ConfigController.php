...
class ConfigController extends Controller
{
        public function geocode_api(Request $request)
    {
        ...
        $response = Http::get('https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key='."your-google-api-here");
    ...
    public function place_api_autocomplete(Request $request)
    {
        ...
        $response = Http::get('https://maps.googleapis.com/maps/api/place/autocomplete/json?input='.$request['search_text'].'&key='.'your-google-api-here');
        return $response->json();
    }
        ...
        public function place_api_details(Request $request)
    {
        ...
        $response = Http::get('https://maps.googleapis.com/maps/api/place/details/json?placeid='.$request['placeid'].'&key='.'your-google-api-here');
        return $response->json();
    }
}
